...
switch($_GET[act]){
    ...
    if ($jumlah%$limit) {
      ...
      for ($i=1;$i<=$halaman;$i++) {
        $newoffset=$limit*($i-1);
          if ($offset!=$newoffset)
            {
            echo "<b><font face=\"arial\" size=\"3\"><a style=\"color: black\"  href=\"media.php?module=produk&offset=$newoffset\">$i</a>&nbsp;&nbsp;</font></B>";
          } else {
    ...
    $no = $offset+1;
	 while($r=mysql_fetch_array($result)){
      ...
      echo "<tr><td>$no</td>
		        ...
		        <a href=$aksi?module=produk&act=hapus&id=$r[id_produk]&namafile=$r[gambar]'><img src='images/icn_trash.png' title='Hapus'></a>
				</td>
  ...
  case "editproduk":
    ...
    echo "</select></td></tr>
          ...
          <tr><td>Deskripsi</td>   <td> <textarea name='deskripsi' class='ckeditor' style='width: 600px; height: 350px;'>$r[deskripsi]</textarea></td></tr>
          <tr><td>Gambar</td>       <td> :  
