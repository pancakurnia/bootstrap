...
echo'<div class="banner">
  ...
  $sql=mysql_query("SELECT * FROM produk ORDER BY id_produk DESC LIMIT 4");
  ...
  $deskripsi=substr($r[deskripsi],0,50);
  	echo"
                ...
                <div class='banner-text'>
                      <h1>$r[nama_produk]</h1>
                      <p>$deskripsi</p>
                      <a href='media.php?module=detailproduk&id=$r[id_produk]'> Klik Disini <span></span></a></div>
              </div>";
			  }
  ...
  echo "<div class='latest-product'>
        <br><h2>Produk Terbaru </h2></div>";
  ...
  while ($r=mysql_fetch_array($sql)){
	...
	echo "<div class='product-info'>
		<table>
		   <tr><img src='foto_produk/small_$r[gambar]' border='0' /></tr>
           <tr> <h2><a href='media.php?module=detailproduk&id=$r[id_produk]'>$r[nama_produk]</a></h2></tr>
           <tr><div ><span>$divharga</span></div></tr>
           <tr> <td> <a href='#'>$tombol </a></td>
				<td><a href='media.php?module=detailproduk&id=$r[id_produk]' class='product-detail'><h2>Detail</h2></a></td>				
		   </tr>
		</table>
          </div>";
  }
...
elseif ($_GET[module]=='detailproduk'){
  ...
  echo "
    	   <div class='product-detail'>
              <div class='img'><a href='foto_produk/$r[gambar]'>
			  <img src='foto_produk/$r[gambar]' border='0' width='230' height='210'/></a><br/>
...
elseif ($_GET[module]=='detailkategori'){
  ...
  // Tampilkan daftar produk yang sesuai dengan kategori yang dipilih
 	$sql = mysql_query("SELECT * FROM produk WHERE id_kategori='$_GET[id]' 
            ORDER BY id_produk DESC LIMIT 12");		 
...
// HASIL PENCARIAN
  ...
  $detaiproduk = htmlentities(strip_tags($t['deskripsi'])); 
  $detailproduk = substr($detailproduk,0,400); 
  $detailproduk = substr($detailproduk,0,strrpos($detailprodyuk," ")); 
  
  echo "<div>
  <a href='media.php?module=detailproduk&id=$t[id_produk]'><h5>$t[nama_produk]</h5></a></span></div>
  ...
  <div class='hasilcari'>$isi ... <a href='media.php?module=detailproduk&id=$t[id_produk]' class='prod_details'>
  <span class='lengkap2'>[Detail]</a></div> <BR/><div class='main-spacer'>&nbsp;</div>";}}
  else{
...
if (empty($_SESSION[username]) AND empty($_SESSION[password])) {
	echo "<div id='info'>Silahkan anda login terlebih dahulu, untuk mendapatkan layanan ini!</div>";
	 echo "<div class='login-box'>
		<h2> KONTAK KAMI </h2>
		<br>
	 <table width=50% style='border: 0pt dashed #F10808; padding:1px;'>
		<tr><td><img src='images/outlook.jpg'></td><td>sofar@outlook.com</td></tr>
		<tr><td><img src='images/whatsapp.png'></td><td>+6285766333996 </td></tr>
		<tr><td><img src='images/telegram.jpg'></td><td>@sofarstmik	</td></tr>	
		<tr><td><img src='images/gmail.jpg'></td><td>sofar@gmail.com</td></tr>
		</table>
		 </div>";
}
else {
  ...
  echo "<div class='login-box'>
        <table width=100% style='border: 2pt dashed #0000CC;padding: 10px;'>		
		...
		<tr><td>Nomor Rekening</td><td> : $r[rekening]</td></tr>
		<tr><td>Nomor Telpon</td><td> : $r[telpon]</td></tr>
		...
		<tr><td>*note: jika anda mengalami masalah dalam pemesanan hubungi kami secara langsung*</td></tr>
		</td><td colspan=2><input type=submit name=submit value=Kirim class='button' ></td></tr>
		</form></table>
		<br>
		 <table width=100% style='border: 1pt dashed #F10808;padding: 5px;'>
		<tr><td> kontak kami di bawah ini 	</td></tr> <br>
		<tr><td> Email       : sofar@gmail.com	</td></tr>
		<tr><td> No Whatsapp : 085766333996	</td></tr>
		<tr><td> No Telpon   : 081316551497	</td></tr>
		<tr><td> Telegram    : @sofarstmik	</td></tr>	
		</table>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Terimakasih</div>
              <div>
              <br />Terimakasih telah menghubungi kami.<br /><br /> Kami akan segera Merespon Pemesanan Anda lewat email mohon cek email anda.
              </div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
elseif ($_GET[module]=='profilKustomer') {
	...
	<h2>Profil Saya</h2>
	  ...
	  <tr><td>Nomor Telpon</td><td> $p[telpon]</td></tr>
...
<h2>Form Edit Your Profil</h2>
	  ...
	  <tr><td>Nomor Telpon</td><td>  <input type=text name=telpon value='$e[telpon]'></td></tr>
...
elseif (empty($_POST[nama]) || empty($_POST[password]) || empty($_POST[alamat]) || empty($_POST[rekening]) || empty($_POST[telpon]) || empty($_POST[email]) || empty($_POST[kota]) || empty($_POST[kode])){
...
mysql_query("INSERT INTO kustomer(nama_lengkap, password, alamat, rekening, telpon, email, id_kota) 
             VALUES('$_POST[nama]','$password','$_POST[alamat]','$_POST[rekening]','$_POST[telpon]','$_POST[email]','$_POST[kota]')");
...
<h2>Form Register</h2>
	  ...
	  <tr><td>Nomor Telepon</td><td>  <input type=text name=telpon></td></tr>
      <tr><td>Email</td><td>  <input type=text name=email size=30></td></tr>
      <tr><td valign=top>Kota Tujuan</td><td>   
      <select name='kota'>
      <option value=0 selected>- Pilih Kota -</option>";
...
";                      
  ...
  echo "<h2>Kustomer Baru</h2>";
	  ...
	  <tr><td>Nomor Telpon</td><td>  <input type=text name=></td></tr>
      <tr><td>Email</td><td>  <input type=text name=email size=30></td></tr>
      <tr><td valign=top>Kota Tujuan</td><td>   
      <select name='kota'>
      <option value=0 selected>- Pilih Kota -</option>";
...
$pesan="Terimakasih telah melakukan pemesanan online di toko online kami <br /><br />  
        ...
        Alamat: $r[alamat] <br/>
        Nomor Telpon: $r[telpon] <br />
		Nomor Telpon: $r[telpon] <br /><hr />
...
echo "<hr /><p>
			<div style='color:#E1473D;border:1px solid #E78686;padding:10px;background:#FFE1E1;'>
			  ...
			  Anda dapat melakukan Konfirmasi Pembayaran Melalui Kontak Kami atau SMS Ke NO : <b>085766333996</b> 
			  <br/>Dengan Format : 
			  <b>#No Orders #Nominal Transfer # Bank Pengirim (no rekening dan nama pemilik) # Bank Tujuan </b> Contoh : 
			  <b> # $id_orders #$grandtotal_rp #padang #Mandiri  </b></div> <br /> <br />
               Apabila Anda tidak melakukan pembayaran dalam 1 hari, maka transaksi kami anggap batal.</p><br />    ";
